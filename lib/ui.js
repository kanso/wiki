...
exports.prepareDoc = function (doc, req) {
    doc.history = exports.PREV_DOC.history || [];
    ...
    doc._attachments['history/' + h._id + '.json'] = {
        data: base64.encode(JSON.stringify(exports.PREV_DOC))
    };
    return doc;
};
...
exports.bindEditor = function (doc, req) {
    ...
    $('#edit_page_form').submit(function (ev) {
        ...
        exports.CURRENT_DOC = exports.prepareDoc(exports.CURRENT_DOC, req);
