var datelib = require('datelib'),
    ...
    syntax_highlight = require('./syntax_highlight'),
    sanitize = require('sanitize'),
    base64 = require('base64'),
    _ = require('underscore')._,
    editor_buttons = require('./editor_buttons');
...
exports.bindEditor = function (doc, req) {
    ...
    $('#preview_btn').click(function () {
        ...
        var val = showdown.convert(exports.CURRENT_DOC.body);
        console.log(['preview', val]);
        $('#preview').html(
            showdown.convert(exports.CURRENT_DOC.body) || '&nbsp;'
        );
        $('#preview').show();
        syntax_highlight();
    });
